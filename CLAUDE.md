...
**当前阶段：** v2.7.3 — 废土副本4周目完整重写 + ScenarioWriter skill 重大升级（第二人称/分段生成/灯停规则/自检脚本/build.js报错）。待办：用新 skill 重新生成 starfield/hermit 副本内容。
...
| v2.8+ | 用 skill 重新生成副本内容 / Mac 适配 / Linux 打包 / Steam | 待定 |
