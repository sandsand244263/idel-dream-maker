...
**当前阶段：** v2.7.4 — 副本生命周期管理（归档+催更+反馈）。删除不完整的 starfield/hermit 副本。新增归档功能、全部通关催更入口、设置反馈面板。
...
| **2.7.4** | **2026-06-20** | **副本生命周期管理：** 删除不完整的 hermit/starfield 副本；新增归档功能(所有周目通关后可归档隐藏+已归档折叠区)；新增全部通关催更入口(大厅提示→打开设置面板，一次性消除)；新增设置面板反馈区块(邮箱复制+导出日志到桌面+打开日志文件夹)。 |
