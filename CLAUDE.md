...
**当前阶段：** v2.3（进行中） — Frutiger Aero 主题 Phase 2

| 项目 | 值 |
|------|-----|
| 当前版本 | 2.3.0 |
| 版本策略 | 主版本.功能版本.修复版本 |
| 下一阶段 | v2.3 — Frutiger Aero 子窗口同步 / 主题深化 |
...
| **v2.3** | **Frutiger Aero 主题 Phase 2** | ➡️ |
...
| **2.3.0** | **2026-06-14** | **Frutiger Aero 主题原型：** 新增 `.theme-aero` 主题类，亮蓝绿渐变背景 + 毛玻璃标题栏 + 光泽按钮 + 设置面板选项 |
