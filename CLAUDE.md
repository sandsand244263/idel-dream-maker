...
| 副本等级公式 | LV1-100: `floor(sqrt(exp/100))+1`；LV100+: `100 + floor((exp-980100)/30000)` | 分段加速，LV500 约117天（8h/天） |
...
**当前阶段：** v2.7.3 — 修复等级曲线加速系数（30000→6000），LV500从450天回归117天设计目标。下一阶段：用 skill 重新生成副本内容（带新字段）。
...
| **2.7.3** | **2026-06-18** | **Bug修复：** 修复等级曲线（LV100+）EXP系数30000→6000，对齐文档"LV500约117天（8h/天）"目标。旧值30000实际需450天，现在匹配117天设计值。同步修复前端calcLevel/calcExpForLevel。 |
