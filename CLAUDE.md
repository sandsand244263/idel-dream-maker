...
**当前阶段：** v2.7.2（已完成） — 基于 UI/UX Pro Max skill 完成 6 项优化：阅读文本行距加宽、侧面板滚动条稳定、事件弹窗层级提升、骨架屏加载反馈、动画 will-change、字体加载策略。下一阶段：用 skill 重新生成副本内容（带新字段）。
...
| v2.7+ | 用 skill 重新生成副本内容 / Mac 适配 / Linux 打包 / Steam | 待定 |
